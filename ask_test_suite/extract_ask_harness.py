...
REQUIRED_FUNCTIONS = [
    'fmt', 'valueFor', 'getFinishedSeasons', 'latestFinishedSeason', 'inProgressPowerNote', 'draftNorm', 'managerForTeam', 'computeKeeperHistory',
    'scorePowerRankingRows', 'computePowerRankings', 'computeCareerPowerRankings',
    'computeValueKeepers', 'levenshtein', 'findManagersInText', 'findYearInText',
    'findPlayerInText', 'h2hRecord', 'winnerOf', 'marginOf', 'formatDateTime',
    'computeKeeperLockDate', 'askAnswer',
]
